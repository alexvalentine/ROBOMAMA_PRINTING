...
insulating_height_top = (0.030+.03,)*16 
...
#g.set_home(x=0, y=0)
#
#print_sacrificial(trace_speed = 5, height = -0.075, over = 0.75, nozzle = 'C', overhang = 0)
