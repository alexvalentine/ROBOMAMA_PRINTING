...
automator.rezero_nozzles(['C'], alignment_path=r"C:\Users\Lewis Group\Desktop\Calibration\alignment_data.txt", cal_file=False)
############
...
#g.abs_move(**{'A':(automator.substrate_origins[active_slide]['A'][2]+ 2.5)})
#g.dirct_write = False
###############Reset zeros ############
