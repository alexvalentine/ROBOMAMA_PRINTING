...
def stiff_TPU_LED_strain(valve,nozzle,height,speed,dwell,pressure):
    g.feed(25)
    g.set_pressure(pressure_box, pressure)
    
    #
    ########test line
    g.abs_move(x=3.5,y=20)
    g.abs_move(**{nozzle:height})
    if valve is not None:
        g.set_valve(num = valve, value = 1)
    g.dwell(dwell)
    ...
    if valve is not None:
        g.set_valve(num = valve, value = 1)
    g.dwell(dwell)
    g.meander(x=5,y=4,spacing=0.5,orientation='x',start='LL')

    g.move(y=-2)
    g.move(y=-1)
    g.meander(x=25,y=2,spacing=0.5,orientation='x',start='LL')
    g.move(y=1)
    g.meander(x=5,y=4,spacing=0.5,orientation='x',start='UL')
    g.set_valve(num = valve, value = 0)
    g.feed(40)
...
def pickandplace(valve,nozzle,speed,dwell):
    ...
    ##LED 1
    g.abs_move(x = 51.131, y = 61.235)
    g.feed(10) 
    g.abs_move(**{nozzle:7.716463+1})
    g.feed(0.08)
    g.abs_move(**{nozzle:7.716463})
    #g.toggle_pressure(pressure_box)
    g.dwell(dwell)
    g.feed(1)
    g.move(**{nozzle:5})
    ...
    ##LED 2
    g.abs_move(x = 46.062, y = 61.199)
    g.feed(10) 
    g.abs_move(**{nozzle:7.990363+1})
    g.feed(0.08)
    g.abs_move(**{nozzle:7.990363})
    #g.toggle_pressure(pressure_box)
    g.dwell(dwell)
    g.feed(1)
    g.move(**{nozzle:5})
    ...
    ##LED 3
    g.abs_move(x = 41.0127, y = 61.2)
    g.feed(10) 
    g.abs_move(**{nozzle:7.960063+1})
    g.feed(0.08)
    g.abs_move(**{nozzle:7.960063})
    #g.toggle_pressure(pressure_box)
    g.dwell(dwell)
    g.feed(1)
    g.move(**{nozzle:5})
    ...
    ##LED 4
    g.abs_move(x = 36.084144, y = 61.157)
    g.feed(10) 
    g.abs_move(**{nozzle:8.318663+1})
    g.feed(0.08)
    g.abs_move(**{nozzle:8.318663})
    #g.toggle_pressure(pressure_box)
    g.dwell(dwell)
    g.feed(1)
    g.move(**{nozzle:5})
    ...
    ##LED 5
    g.abs_move(x = 15.811292, y = 64.905)
    g.feed(10) 
    g.abs_move(**{nozzle:9.040763+1})
    g.feed(0.08)
    g.abs_move(**{nozzle:9.040763})
    #g.toggle_pressure(pressure_box)
    g.dwell(dwell)
    g.feed(1)
    g.move(**{nozzle:5})
    ...
    ##LED 6
    g.abs_move(x = 15.878292, y = 68.745)
    g.feed(10) 
    g.abs_move(**{nozzle:9.048963+1})
    g.feed(0.08)
    g.abs_move(**{nozzle:9.048963})
    #g.toggle_pressure(pressure_box)
    g.dwell(dwell)
    g.feed(1)
    g.move(**{nozzle:5})
    ...
    ##LED 7
    g.abs_move(x = 20.889292, y = 68.804)
    g.feed(10) 
    g.abs_move(**{nozzle:8.859763+1})
    g.feed(0.08)
    g.abs_move(**{nozzle:8.859763})
    #g.toggle_pressure(pressure_box)
    g.dwell(dwell)
    g.feed(1)
    g.move(**{nozzle:5})
    ...
    ##LED 8
    g.abs_move(x = 20.896292, y = 64.782)
    g.feed(10) 
    g.abs_move(**{nozzle:8.799763+1})
    g.feed(0.08)
    g.abs_move(**{nozzle:8.799763})
    #g.toggle_pressure(pressure_box)
    g.dwell(dwell)
    g.feed(1)
    g.move(**{nozzle:5})
    ...
    ##LED 9
    g.abs_move(x = 15.899292, y = 60.996)
    g.feed(10) 
    g.abs_move(**{nozzle:9.218763+1})
    g.feed(0.08)
    g.abs_move(**{nozzle:9.218763})
    #g.toggle_pressure(pressure_box)
    g.dwell(dwell)
    g.feed(1)
    g.move(**{nozzle:5})
    ...
    ##LED 10
    g.abs_move(x = 20.848292, y = 61.042)
    g.feed(10) 
    g.abs_move(**{nozzle:8.919763+1})
    g.feed(0.08)
    g.abs_move(**{nozzle:8.919763})
    #g.toggle_pressure(pressure_box)
    g.dwell(dwell)
    g.feed(1)
    g.move(**{nozzle:5})
    ...
    ##LED 11
    g.abs_move(x = 25.902292, y = 61.166)
    g.feed(10) 
    g.abs_move(**{nozzle:8.594963+1})
    g.feed(0.08)
    g.abs_move(**{nozzle:8.594963})
    #g.toggle_pressure(pressure_box)
    g.dwell(dwell)
    g.feed(1)
    g.move(**{nozzle:5})
    ...
    ##LED 12
    g.abs_move(x = 30.974292, y = 61.157)
    g.feed(10) 
    g.abs_move(**{nozzle:8.421663+1})
    g.feed(0.08)
    g.abs_move(**{nozzle:8.421663})
    #g.toggle_pressure(pressure_box)
    g.dwell(dwell)
    g.feed(1)
    g.move(**{nozzle:5})
...
def pickandplace_magnets(valve,nozzle,speed,dwell):
    ...
    ##magnet 1
    g.abs_move(x = 56.60517, y = 59.182)
    g.feed(10) 
    g.abs_move(**{nozzle:8.424579+1})
    g.feed(0.08)
    g.abs_move(**{nozzle:8.424579})
    #g.toggle_pressure(pressure_box)
    g.dwell(dwell)
    g.feed(1)
    g.move(**{nozzle:5})
    g.feed(10)
    g.abs_move(x = 40.906726, y = 7.001) 
    g.abs_move(**{nozzle:1.336219+1})
    g.feed(0.08) 
    g.abs_move(**{nozzle:1.336219})
    #g.toggle_pressure(pressure_box)
    g.dwell(dwell)
    g.feed(1)
    g.abs_move(**{nozzle:3})
    ...
    ##magnet 1
    g.abs_move(x = 23.624628, y = 69.309)
    g.feed(10) 
    g.abs_move(**{nozzle:9.522019+1})
    g.feed(0.08)
    g.abs_move(**{nozzle:9.522019})
    #g.toggle_pressure(pressure_box)
    g.dwell(dwell)
    g.feed(1)
    g.move(**{nozzle:5})
    g.feed(10)
    g.abs_move(x = 57.430628, y = 7.049) 
    g.abs_move(**{nozzle:1.336219+1})
    g.feed(0.08) 
    g.abs_move(**{nozzle:1.336219})
    #g.toggle_pressure(pressure_box)
...
TPU_spacing_tests(valve='3',nozzle='C',height=0.4,speed=10.2,dwell=0.2,pressure=6)
g.toggle_pressure(pressure_box)
...
#stiff_TPU_LED_strain(valve='2',nozzle='B',height=0.339+.4,speed=5,dwell=0.4,pressure=30)
#
#g.toggle_pressure(pressure_box)
#
...
#AgTPU_strain_speciman(valve='1',nozzle='A',height=0.125-.1,speed=4,dwell=0.1,pressure=15)
#
#g.toggle_pressure(pressure_box)
##
...
##
#g.toggle_pressure(pressure_box)
#LED_Harvard_connectors(valve='1',nozzle='A',height=0.5,speed=2,dwell=2.8,pressure=70,startx=8,starty=7)
#g.toggle_pressure(pressure_box)
...
#pickandplace_magnets(valve='3',nozzle='C',speed=10,dwell=10)
