...
align_top_pressure=(10,)*16#(10,)*16
...
###
active_slide = 'slide1'
z_ref = -70.56649#automator.substrate_origins[active_slide]['A'][2]#-69.558571
####
#active_slide = 'slide2'
#z_ref = -69.546409
...
print_all_single_wells(layer_height = 0.35, layer_increments=5, total_increments=6, pressure=30, speed=20, nozzle = 'B', valve = 0)
